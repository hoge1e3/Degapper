...
CKR2=function () {
    ...
    var assignment_expression=g("assignment_expression",ors(
    ...
    loep.postfix(prio, ors(
        ...
        ands(LP, argument_expression_list, RP),
        ands(tk("."), identifier),
        ands(tk("->"), identifier),
        tk("++"),
        tk("--")
    ...
    var compound_statement=g("compound_statement", ands(
            LC,
            G("declaration_list").opt(), statement_list.opt(),
            RC
    ));
...
//        ands(sp("("),  abstract_declarator ,sp(")") ),
    ...
    */
    ...
    var external_declaration = g("external_declaration", ors( function_definition, declaration) );
    var translation_unit= g("translation_unit", external_declaration.rep1().ret(makeRepNodeF()) ) ;
//  g\("(\w+)   var $1=g\("$1
